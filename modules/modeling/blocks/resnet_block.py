...
class _ResNetBaseBlock(BaseBlock):
    ...
    def __init__(self, cin: int, cout: int, kernel_size: int, expand_ratio: float, stride: int, activation: Union[str, Type[nn.Module]] = 'relu', use_se=False) -> None:
...
class ResNetBlock(_ResNetBaseBlock):
    ...
    def __init__(self, cin: int, cout: int, kernel_size: int, expand_ratio: float, stride: int, activation: Union[str, Type[nn.Module]] = 'relu') -> None:
